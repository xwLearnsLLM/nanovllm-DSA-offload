...
TORCH_LIBRARY_IMPL(nanovllm_dsa, PrivateUse1, m) {
  m.impl("lidu_cache_update", &nanovllm_dsa_a5_impl::LiduCacheUpdateNpu);
  m.impl("lidu_cache_update_out", &nanovllm_dsa_a5_impl::LiduCacheUpdateOutNpu);
}

TORCH_LIBRARY_IMPL(nanovllm_dsa, Meta, m) {
  m.impl("lidu_cache_update", &nanovllm_dsa_a5_impl::LiduCacheUpdateMeta);
  m.impl("lidu_cache_update_out", &nanovllm_dsa_a5_impl::LiduCacheUpdateOutMeta);
}
