...
from .kvcache_scatter_copy_c8 import _packed_byte_view
...
@torch.library.custom_op(
    "nanovllm_dsa::sparse_tail_attention_c8",
    mutates_args=(),
)
def _sparse_tail_attention_c8(
    query: torch.Tensor,
    packed_kv: torch.Tensor,
    sparse_and_tail_slots: torch.Tensor,
    block_table: torch.Tensor,
...
@_sparse_tail_attention_c8.register_fake
def _sparse_tail_attention_c8_fake(
    query: torch.Tensor,
    packed_kv: torch.Tensor,
    sparse_and_tail_slots: torch.Tensor,
    block_table: torch.Tensor,
