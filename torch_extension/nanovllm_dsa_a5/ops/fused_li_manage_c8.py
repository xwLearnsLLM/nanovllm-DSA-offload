...
_fused_li_manage_c8_cache_update = torch.ops.nanovllm_dsa._fused_li_manage_c8_cache_update
_fused_li_manage_c8_cache_update_out = torch.ops.nanovllm_dsa._fused_li_manage_c8_cache_update_out
...
def _fused_li_manage_c8_impl(
    ...
    return _fused_li_manage_c8_cache_update(
        topk,
        req_pool_entries,
        cache_slots_pool,
        cache_tokens,
...
def _fused_li_manage_c8_out_impl(
    query: torch.Tensor,
    key: torch.Tensor,
    weights: torch.Tensor,
    query_dequant_scale: torch.Tensor,
    ...
    return _fused_li_manage_c8_cache_update_out(
        topk,
        req_pool_entries,
        cache_slots_pool,
        cache_tokens,
...
def _fused_li_manage_c8_out_meta(
    query: torch.Tensor,
    key: torch.Tensor,
    weights: torch.Tensor,
    query_dequant_scale: torch.Tensor,
...
_C8_LIDU_NPU_IMPL.impl(
    "fused_li_manage_c8", _fused_li_manage_c8_impl
)
_C8_LIDU_NPU_IMPL.impl(
    "fused_li_manage_c8_out", _fused_li_manage_c8_out_impl
)
_C8_LIDU_META_IMPL = torch.library.Library("nanovllm_dsa", "IMPL", "Meta")
_C8_LIDU_META_IMPL.impl(
    "fused_li_manage_c8", _fused_li_manage_c8_meta
)
_C8_LIDU_META_IMPL.impl(
    "fused_li_manage_c8_out", _fused_li_manage_c8_out_meta
)
