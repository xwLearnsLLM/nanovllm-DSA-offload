...
__aicore__ inline void InitTaskParamByRun(const RunParamStr& runParam, RunInfo &runInfo)
{
    ...
    runInfo.cacheTokenCount = runParam.cacheTokenCount;
    runInfo.sparseTokenCount = runParam.sparseTokenCount;
    runInfo.tailTokenCount = runParam.tailTokenCount;
    runInfo.tailSlotStart = runParam.tailSlotStart;
    runInfo.virtualS2Size = runParam.virtualS2Size;
