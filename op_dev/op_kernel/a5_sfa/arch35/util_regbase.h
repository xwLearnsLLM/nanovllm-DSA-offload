...
struct RunParamStr {  // 分核与切块需要使用到参数
    COMMON_RUN_PARAM;
    // Physical HBM layout: C selected tokens followed by a contiguous tail.
    // The attention loop consumes virtual top-2048 + tail tokens.
    int32_t cacheTokenCount = 0;
    int32_t sparseTokenCount = 0;
    int32_t tailTokenCount = 0;
    int32_t tailSlotStart = 0;
    int32_t virtualS2Size = 0;
    /* 推理新增 */
