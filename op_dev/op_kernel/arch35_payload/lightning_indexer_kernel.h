...
public:
    ...
    __aicore__ inline void Init(__gm__ uint8_t *query, __gm__ uint8_t *key, __gm__ uint8_t *weights,
                                __gm__ uint8_t *reqPoolEntries, __gm__ uint8_t *cacheTokens,
                                ...
                                __gm__ uint8_t *workspace, const LIA5TilingData *__restrict tiling, TPipe *tPipe);
...
protected:
    ...
    // ================================Init functions==================================
    __aicore__ inline void InitTilingData(const LIA5TilingData *__restrict tilingData);
...
template <typename LIT>
__aicore__ inline void LightningIndexerKernel<LIT>::InitTilingData(const LIA5TilingData *__restrict tilingData)
{
...
__aicore__ inline void LightningIndexerKernel<LIT>::Init(__gm__ uint8_t *query,
                                              ...
                                              __gm__ uint8_t *cacheSlots, __gm__ uint8_t *topkSlots,
                                              __gm__ uint8_t *missCount,
                                              __gm__ uint8_t *workspace,  const LIA5TilingData *__restrict tiling,
                                              TPipe *tPipe)
{
    if ASCEND_IS_AIV {
