...
def run_lidu_scatter_chain_case(device: torch.device, seed: int) -> None:
    ...
    eager_counts = validate_result(
        ...
        eager_cache,
        eager_outputs,
        label="lidu_scatter_chain/eager",
    )
    payload_counts = assert_scatter_result(
        eager_kpe, eager_ckv, eager_outputs, label="lidu_scatter_chain/eager"
    )
    ...
    graph_counts = validate_result(
        ...
        graph_cache,
        graph_outputs,
        label="lidu_scatter_chain/graph",
    )
    assert_scatter_result(
        graph_kpe, graph_ckv, graph_outputs, label="lidu_scatter_chain/graph"
    )
    ...
    repeat_counts = validate_result(
        ...
        graph_cache,
        graph_outputs,
        label="lidu_scatter_chain/graph_repeat",
    )
    if any(repeat_counts):
...
def main() -> None:
    ...
    run_lidu_scatter_chain_case(device, args.seed)
