...
```bash
PYTHONPATH=$PWD:$PYTHONPATH NANOVLLM_MAX_GEN_TOKENS=5 NANOVLLM_PROMPT_LENGTHS=9000,9001,9002,9003,9004,9005,9006,9007 NANOVLLM_LOG_DECODE_LAYER_TIMING=1 NANOVLLM_DECODE_LAYER_TIMING_SYNC=0 NANOVLLM_PROFILE_LAYER_IDS=mid python3 example/test.py
```

2. 混合长短序列（随机无意义tokens），不打印时延分解：

```bash
PYTHONPATH=$PWD:$PYTHONPATH NANOVLLM_MAX_GEN_TOKENS=5 NANOVLLM_PROMPT_LENGTHS=9000,9001,9002,9003,9004,9005,9006,9007 python3 example/test.py
```
