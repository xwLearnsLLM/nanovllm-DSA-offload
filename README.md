...
```bash
PYTHONPATH=$PWD:$PYTHONPATH NANOVLLM_MAX_GEN_TOKENS=5 NANOVLLM_PROMPT_LENGTHS=200,18000,18001,18002,18003,18004,18005,18006,18007 NANOVLLM_LOG_DECODE_LAYER_TIMING=1 NANOVLLM_DECODE_LAYER_TIMING_SYNC=0 NANOVLLM_PROFILE_LAYER_IDS=mid python3 example/test.py
```

2. 混合长短序列（随机无意义tokens），不打印时延分解：

```bash
PYTHONPATH=$PWD:$PYTHONPATH NANOVLLM_MAX_GEN_TOKENS=5 NANOVLLM_PROMPT_LENGTHS=200,18000,18001,18002,18003,18004,18005,18006,18007 python3 example/test.py
```
