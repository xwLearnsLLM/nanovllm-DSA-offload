...
def ascend950_fp8_mx_grouped_matmul_finalize_routing(
    ...
    Args:
        ...
        mat2: Right input (float8_e4m3fn), shape ``(problem_count, N, K)`` when transB=True.
