...
[[bisheng::core_ratio(1, 2)]] CATLASS_GLOBAL void PaddingSingleCoreSplitkForSmallKMatmulKernel(uint64_t hardwareSyncAddr, __gm__ uint8_t *__restrict__ gmA,
...
template <class ArchTag, class ElementA, class LayoutA, class ElementB, class LayoutB, class ElementC, class LayoutC,
    PaddingTag paddingTagA, PaddingTag paddingTagB,  PaddingTag paddingTagC>
void LaunchPaddingSingleCoreSplitkForSmallKMatmulKernel(aclrtStream &stream, uint64_t hardwareSyncAddr, uint8_t *dA, uint8_t *dB, uint8_t *dC,
