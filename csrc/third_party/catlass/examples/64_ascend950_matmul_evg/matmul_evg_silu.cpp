...
static void Run(const Options &options) {
    ...
    using EVG = Epilogue::Fusion::TreeVisitor<
        ...
        Epilogue::Fusion::TreeVisitor<
            Epilogue::Fusion::VisitorCompute<Epilogue::Fusion::Silu, ElementC>,
    ...
    golden::ComputeMatmulElemWiseSilu(options.problemShape, hostA, tagA, hostB, tagB, hostGolden, tagC);
