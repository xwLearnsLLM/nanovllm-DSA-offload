...
#include "../op_kernel/a5_sparse_tail_attention_c8_stage2_template_tiling_key.h"
#include "a5_sparse_tail_attention_c8_stage2_tiling.h"
...
IMPL_OP_OPTILING(A5SparseTailAttentionC8Stage2)
