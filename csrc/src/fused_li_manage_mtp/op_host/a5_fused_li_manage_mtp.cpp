...
namespace ops {
class A5FusedLiManageMtp : public OpDef {
public:
    explicit A5FusedLiManageMtp(const char *name) : OpDef(name)
    {
        this->Input("query")
            .ParamType(REQUIRED)
        ...
        this->Output("miss_index").ParamType(REQUIRED).DataTypeList({ge::DT_INT32}).FormatList({ge::FORMAT_ND});
        this->Output("miss_slots").ParamType(REQUIRED).DataTypeList({ge::DT_INT32}).FormatList({ge::FORMAT_ND});
