#ifndef SPARSE_TAIL_ATTENTION_C8_STAGE1_TEMPLATE_TILING_KEY_H
#define SPARSE_TAIL_ATTENTION_C8_STAGE1_TEMPLATE_TILING_KEY_H
...
ASCENDC_TPL_ARGS_DECL(A5SparseTailAttentionC8Stage1,
