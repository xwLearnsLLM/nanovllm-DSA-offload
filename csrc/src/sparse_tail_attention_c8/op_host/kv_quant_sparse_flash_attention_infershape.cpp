...
ge::graphStatus InferShapeA5SparseTailAttentionC8(gert::InferShapeContext *context)
{
    OP_CHECK_IF(context == nullptr, OP_LOGE_WITH_INVALID_INPUT("A5SparseTailAttentionC8", "InferShapeContext"),
...
ge::graphStatus InferDataTypeA5SparseTailAttentionC8(gert::InferDataTypeContext *context)
{
    OP_CHECK_IF(context == nullptr, OP_LOGE_WITH_INVALID_INPUT("A5SparseTailAttentionC8", "InferShapeContext"),
               return ge::GRAPH_FAILED);
...
IMPL_OP_INFERSHAPE(A5SparseTailAttentionC8)
    .InferShape(InferShapeA5SparseTailAttentionC8)
    .InferDataType(InferDataTypeA5SparseTailAttentionC8);
} // namespace ops
