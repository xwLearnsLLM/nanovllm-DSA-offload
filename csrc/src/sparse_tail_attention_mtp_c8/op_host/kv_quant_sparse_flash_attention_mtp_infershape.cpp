...
ge::graphStatus InferShapeA5SparseTailAttentionMtpC8(gert::InferShapeContext *context)
{
    OP_CHECK_IF(context == nullptr, OP_LOGE_WITH_INVALID_INPUT("A5SparseTailAttentionMtpC8", "InferShapeContext"),
    ...
    *attentionOutShape = *queryShape;
    ...
    if (return_softmax_lse) {
        ...
        // Some CANN/ACLNN runtimes reject a required zero-size output
        // descriptor. These outputs are unused when return_softmax_lse=false.
...
ge::graphStatus InferDataTypeA5SparseTailAttentionMtpC8(gert::InferDataTypeContext *context)
{
    OP_CHECK_IF(context == nullptr, OP_LOGE_WITH_INVALID_INPUT("A5SparseTailAttentionMtpC8", "InferShapeContext"),
               return ge::GRAPH_FAILED);
...
IMPL_OP_INFERSHAPE(A5SparseTailAttentionMtpC8)
    .InferShape(InferShapeA5SparseTailAttentionMtpC8)
    .InferDataType(InferDataTypeA5SparseTailAttentionMtpC8);
} // namespace ops
