 ...
 * \brief
 */
#ifndef KV_QUANT_SPARSE_FLASH_ATTENTION_MTP_TILING_H
#define KV_QUANT_SPARSE_FLASH_ATTENTION_MTP_TILING_H
...
// ------------------公共定义--------------------------
enum class QSFALayoutMtp : uint32_t {
    BSND = 0,
    TND = 1,
    PA_BSND = 2,
};

struct QSFATilingShapeCompareParamMtp {
    int64_t B = 1;
    int64_t S = 1;
    int64_t N = 1;
    int64_t D = 1;
...
enum class KvStorageModeMtp : uint32_t {
    BATCH_CONTINUOUS = 0,
    PAGE_ATTENTION = 1
};

enum class QSFAPerfModeMtp : uint32_t {
    C_TEMPLATE_MODE = 0,
    V_TEMPLATE_MODE
};

enum class QSFAAxisMtp : uint32_t {
    B = 0,
    S = 1,
    N = 2,
    D = 3,
...
struct QSFARequiredParaInfoMtp {
    const gert::CompileTimeTensorDesc *desc;
    const gert::StorageShape *shape;
};

struct QSFAOptionalParaInfoMtp {
    const gert::CompileTimeTensorDesc *desc;
    const gert::Tensor *tensor;
};

// -----------算子Tiling入参结构体定义---------------
struct QSFAParaInfoMtp {
    QSFARequiredParaInfoMtp query = {nullptr, nullptr};
    QSFARequiredParaInfoMtp key = {nullptr, nullptr};
    QSFARequiredParaInfoMtp value = {nullptr, nullptr};
    QSFARequiredParaInfoMtp sparseIndices = {nullptr, nullptr};
    QSFAOptionalParaInfoMtp blockTable = {nullptr, nullptr};
    QSFAOptionalParaInfoMtp actualSeqLengthsQ = {nullptr, nullptr};
    QSFAOptionalParaInfoMtp actualSeqLengths = {nullptr, nullptr};
    QSFAOptionalParaInfoMtp queryRope = {nullptr, nullptr};
    QSFAOptionalParaInfoMtp keyRope = {nullptr, nullptr};
    QSFAOptionalParaInfoMtp keyDequantScale = {nullptr, nullptr};
    QSFAOptionalParaInfoMtp valueDequantScale = {nullptr, nullptr};
    QSFARequiredParaInfoMtp attenOut = {nullptr, nullptr};
    QSFARequiredParaInfoMtp softmaxMax = {nullptr, nullptr};
    QSFARequiredParaInfoMtp softmaxSum = {nullptr, nullptr};
...
struct InnerSplitParamsMtp {
    uint32_t s1GBaseSize = 1;
    uint32_t s2BaseSize = 1;
};

// -----------算子TilingData定义---------------
BEGIN_TILING_DATA_DEF(KvQuantSparseFlashAttentionMtpBaseParamsMla)
...
REGISTER_TILING_DATA_CLASS(KvQuantSparseFlashAttentionMtpBaseParamsMlaOp, KvQuantSparseFlashAttentionMtpBaseParamsMla)

BEGIN_TILING_DATA_DEF(KvQuantSparseFlashAttentionMtpSingleCoreParamsMla)
TILING_DATA_FIELD_DEF(uint32_t, usedCoreNum);
END_TILING_DATA_DEF
REGISTER_TILING_DATA_CLASS(KvQuantSparseFlashAttentionMtpSingleCoreParamsMlaOp,
    KvQuantSparseFlashAttentionMtpSingleCoreParamsMla)

BEGIN_TILING_DATA_DEF(KvQuantSparseFlashAttentionMtpSingleCoreTensorSizeMla)
TILING_DATA_FIELD_DEF(uint32_t, mmResUbSize);
TILING_DATA_FIELD_DEF(uint32_t, bmm2ResUbSize);
END_TILING_DATA_DEF
REGISTER_TILING_DATA_CLASS(KvQuantSparseFlashAttentionMtpSingleCoreTensorSizeMlaOp,
    KvQuantSparseFlashAttentionMtpSingleCoreTensorSizeMla)

BEGIN_TILING_DATA_DEF(KvQuantSparseFlashAttentionMtpSplitKVParamsMla)
...
END_TILING_DATA_DEF
REGISTER_TILING_DATA_CLASS(KvQuantSparseFlashAttentionMtpSplitKVParamsMlaOp,
    KvQuantSparseFlashAttentionMtpSplitKVParamsMla)

// 内切基本块参数
BEGIN_TILING_DATA_DEF(KvQuantSparseFlashAttentionMtpInnerSplitParams)
TILING_DATA_FIELD_DEF(uint32_t, mBaseSize)
TILING_DATA_FIELD_DEF(uint32_t, s2BaseSize)
END_TILING_DATA_DEF
REGISTER_TILING_DATA_CLASS(KvQuantSparseFlashAttentionMtpInnerSplitParamsOp,
    KvQuantSparseFlashAttentionMtpInnerSplitParams)

BEGIN_TILING_DATA_DEF(KvQuantSparseFlashAttentionMtpTilingDataMla)
TILING_DATA_FIELD_DEF_STRUCT(KvQuantSparseFlashAttentionMtpBaseParamsMla, baseParams);
TILING_DATA_FIELD_DEF_STRUCT(KvQuantSparseFlashAttentionMtpSplitKVParamsMla, splitKVParams);
TILING_DATA_FIELD_DEF_STRUCT(KvQuantSparseFlashAttentionMtpSingleCoreParamsMla, singleCoreParams);
TILING_DATA_FIELD_DEF_STRUCT(KvQuantSparseFlashAttentionMtpSingleCoreTensorSizeMla, singleCoreTensorSize);
TILING_DATA_FIELD_DEF_STRUCT(KvQuantSparseFlashAttentionMtpInnerSplitParams, innerSplitParams);
END_TILING_DATA_DEF
REGISTER_TILING_DATA_CLASS(A5SparseTailAttentionMtpC8, KvQuantSparseFlashAttentionMtpTilingDataMla)
...
std::string QSFATensorDesc2StringMtp(const gert::StorageShape *shape, const gert::CompileTimeTensorDesc *tensor);
std::string QSFADebugTilingContextMtp(const gert::TilingContext *context);
std::string QSFALayoutMtpToSerialStringMtp(QSFALayoutMtp layout);

// -----------算子Tiling入参信息类---------------
struct QSFATilingInfoMtp {
    const char *opName = nullptr;
    fe::PlatFormInfos *platformInfo = nullptr;
    QSFAParaInfoMtp opParamInfo;
    ...
    KvStorageModeMtp kvStorageMode = KvStorageModeMtp::BATCH_CONTINUOUS;

    QSFALayoutMtp qLayout = QSFALayoutMtp::BSND;
    QSFALayoutMtp topkLayout = QSFALayoutMtp::BSND;
    QSFALayoutMtp outLayout = QSFALayoutMtp::BSND;
    QSFALayoutMtp kvLayout = QSFALayoutMtp::BSND;
...
// ---------------算子Tiling类---------------
class QSFAMlaTilingMtp {
public:
    explicit QSFAMlaTilingMtp(gert::TilingContext *context) : context_(context) {}
    ge::graphStatus DoOpTiling(QSFATilingInfoMtp *qsfaInfo);
...
private:
    ...
    uint32_t coreNum_ = 0;
    QSFAPerfModeMtp perfMode_ = QSFAPerfModeMtp::V_TEMPLATE_MODE;
    ...
    KvQuantSparseFlashAttentionMtpTilingDataMla tilingData_;
    ...
    QSFATilingInfoMtp *qsfaInfo_ = nullptr;
};

// -----------算子Tiling入参信息解析及Check类---------------
class QSFATilingCheckMtp {
public:
    explicit QSFATilingCheckMtp(const QSFATilingInfoMtp &qsfaInfo) : qsfaInfo_(qsfaInfo) {};
    ~QSFATilingCheckMtp() = default;
...
private:
    ...
    ge::graphStatus CheckDimNumInLayoutSupport(const QSFALayoutMtp &layout,
        const gert::StorageShape *shape, const std::string &name) const;
    void LogErrorLayoutSupport(const std::vector<QSFALayoutMtp> &expectLayoutList,
    ...
    ge::graphStatus CompareShape(QSFATilingShapeCompareParamMtp &param,
        const gert::Shape &shape, const QSFALayoutMtp &layout, const std::string &name) const;
    ge::graphStatus CheckLayoutSupport(const QSFALayoutMtp &actualLayout, const std::string &name) const;
...
private:
    ...
    QSFAParaInfoMtp opParamInfo_;
    const QSFATilingInfoMtp &qsfaInfo_;
    ...
    KvStorageModeMtp kvStorageMode_ = KvStorageModeMtp::BATCH_CONTINUOUS;
    ...
    QSFALayoutMtp qLayout_ = QSFALayoutMtp::BSND;
    QSFALayoutMtp topkLayout_ = QSFALayoutMtp::BSND;
    QSFALayoutMtp outLayout_ = QSFALayoutMtp::BSND;
    QSFALayoutMtp kvLayout_ = QSFALayoutMtp::BSND;
...
class QSFAInfoParserMtp {
public:
    explicit QSFAInfoParserMtp(const gert::TilingContext *context) : context_(context) {}
    ~QSFAInfoParserMtp() = default;
    ...
    void GenerateInfo(QSFATilingInfoMtp &qsfaInfo);
    void FillTilingInfoAttrsAndLayouts(QSFATilingInfoMtp &qsfaInfo);
    ge::graphStatus Parse(QSFATilingInfoMtp &qsfaInfo);
...
#endif // KV_QUANT_SPARSE_FLASH_ATTENTION_MTP_TILING_H
