...
#include "../deps/common/CopyInL1.h"
#include "../deps/common/matmul.h"
#include "../deps/common/FixpipeOut.h"
...
public:
    ...
    __aicore__ inline void Init(__gm__ uint8_t *query, __gm__ uint8_t *key, __gm__ uint8_t *value,
                                ...
                                const KvQuantSparseFlashAttentionMtpTilingDataMla *__restrict tiling,
				                TPipe *tPipe);
...
private:
    ...
    __gm__ uint8_t *workspace, const KvQuantSparseFlashAttentionMtpTilingDataMla *__restrict tiling, TPipe *tPipe);
    ...
    const KvQuantSparseFlashAttentionMtpTilingDataMla *__restrict tilingData;
