...
#include "../deps/common/arch35/vf/vf_mul_sel_softmaxflashv2_cast_nz_sfa.h"
#include "../deps/common/arch35/vf/vf_flashupdate_new.h"
...
public:
    ...
    __aicore__ inline void InitVecBlock(TPipe *pipe, const KvQuantSparseFlashAttentionMtpTilingDataMla *__restrict tiling,
