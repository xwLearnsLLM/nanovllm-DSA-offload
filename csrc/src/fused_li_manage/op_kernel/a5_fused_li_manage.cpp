...
/*!
 * \file a5_fused_li_manage.cpp
 * \brief Decode-only LightningIndexer update kernel.
 */

#include "kernel_operator.h"
#include "lib/matmul_intf.h"
#include "a5_fused_li_manage_template_tiling_key.h"
#include "a5_fused_li_manage_kernel.h"
...
template <int DT>
__global__ __aicore__ void a5_fused_li_manage(__gm__ uint8_t *query, __gm__ uint8_t *key, __gm__ uint8_t *weights,
