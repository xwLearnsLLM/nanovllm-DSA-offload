...
static ge::graphStatus InferShapeA5FusedLiManage(
    gert::InferShapeContext *context)
{
    OPS_ERR_IF(context == nullptr,
               OPS_LOG_E("A5FusedLiManage", "InferShapeContext is nullptr."),
...
static ge::graphStatus InferDataTypeA5FusedLiManage(
    gert::InferDataTypeContext *context)
{
    OPS_ERR_IF(context == nullptr,
               OPS_LOG_E("A5FusedLiManage", "InferDataTypeContext is nullptr."),
               return ge::GRAPH_FAILED);
...
IMPL_OP_INFERSHAPE(A5FusedLiManage)
    .InferShape(InferShapeA5FusedLiManage)
    .InferDataType(InferDataTypeA5FusedLiManage);
} // namespace ops
