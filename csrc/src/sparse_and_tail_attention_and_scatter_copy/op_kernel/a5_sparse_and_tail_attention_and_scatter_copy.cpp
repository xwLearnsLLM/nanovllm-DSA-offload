...
#include "a5_sparse_and_tail_attention_and_scatter_copy_template_tiling_key.h"

// The fused payload is the complete SFA tiling payload followed by two
...
a5_sparse_and_tail_attention_and_scatter_copy(
    GM_ADDR query,
    GM_ADDR key,
    GM_ADDR value,
    ...
    GM_ADDR tiling)
{
    ...
    static_assert(
        ...
        "The fused A5 operator supports BF16 only.");
