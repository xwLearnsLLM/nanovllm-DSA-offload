...
namespace optiling {
static ge::graphStatus TilingA5SparseAndTailAttentionAndScatterCopy(
    gert::TilingContext *context)
{
...
InferShapeForA5SparseAndTailAttentionAndScatterCopy(
...
static ge::graphStatus
InferDataTypeForA5SparseAndTailAttentionAndScatterCopy(
...
public:
        ...
        const char *name) : OpDef(name)
    {
        ...
        this->AICore()
            .SetTiling(
                optiling::TilingA5SparseAndTailAttentionAndScatterCopy)
            .AddConfig("ascend950", config);
    }
};
OP_ADD(A5SparseAndTailAttentionAndScatterCopy);

IMPL_OP_INFERSHAPE(A5SparseAndTailAttentionAndScatterCopy)
    .InferShape(InferShapeForA5SparseAndTailAttentionAndScatterCopy)
    .InferDataType(InferDataTypeForA5SparseAndTailAttentionAndScatterCopy);
} // namespace ops
