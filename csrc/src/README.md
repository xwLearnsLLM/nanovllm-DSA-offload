...
- `sparse_and_tail_attention_and_scatter_copy`：W4A8 BF16 基础融合 SCATTER/SFA，本地 CANN op。
- `sparse_and_tail_attention_and_scatter_copy_mte_pipeline`：W4A8 BF16 MTE-pipeline 融合版本，本地 CANN op。
