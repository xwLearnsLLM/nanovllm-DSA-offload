#include "nanovllm_fused_copy_sfa_mtp_tiling.h"
...
ge::graphStatus TilingNanovllmFusedCopySfaMtp(
    gert::TilingContext *context)
{
    ...
    OPS_ERR_IF(raw == nullptr,
               ...
               return ge::GRAPH_FAILED);
    NanovllmFusedCopySfaMtpTilingData fusedTiling;
...
ge::graphStatus TilingPrepareNanovllmFusedCopySfaMtp(
...
IMPL_OP_OPTILING(NanovllmFusedCopySfaMtp)
    .Tiling(TilingNanovllmFusedCopySfaMtp)
    .TilingParse<NanovllmFusedCopySfaMtpCompileInfo>(
        TilingPrepareNanovllmFusedCopySfaMtp);
