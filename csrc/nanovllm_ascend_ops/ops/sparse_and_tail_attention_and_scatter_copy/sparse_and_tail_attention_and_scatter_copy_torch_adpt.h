#ifndef NANOVLLM_SPARSE_AND_TAIL_ATTENTION_AND_SCATTER_COPY_TORCH_ADPT_H
#define NANOVLLM_SPARSE_AND_TAIL_ATTENTION_AND_SCATTER_COPY_TORCH_ADPT_H
...
npu_sparse_and_tail_attention_and_scatter_copy(
  ...
  EXEC_NPU_CMD_ORDERED(
      aclnnNanovllmSparseAndTailAttentionAndScatterCopy,
      keepalive,
      query,
      hbm_kv_cache,
      hbm_kv_cache,
