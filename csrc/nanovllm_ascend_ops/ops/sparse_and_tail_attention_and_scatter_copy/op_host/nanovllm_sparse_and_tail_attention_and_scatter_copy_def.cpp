...
class NanovllmSparseAndTailAttentionAndScatterCopy : public OpDef {
public:
    explicit NanovllmSparseAndTailAttentionAndScatterCopy(const char *name) : OpDef(name)
    {
...
OP_ADD(NanovllmSparseAndTailAttentionAndScatterCopy);
