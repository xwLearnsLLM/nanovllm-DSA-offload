...
/*!
 * \file nanovllm_sparse_and_tail_attention_service_vector_mla.h
 * \brief
 */
#ifndef NANOVLLM_SPARSE_AND_TAIL_ATTENTION_SERVICE_VECTOR_MLA_H
#define NANOVLLM_SPARSE_AND_TAIL_ATTENTION_SERVICE_VECTOR_MLA_H
...
public:
    ...
    __aicore__ inline void InitParams(const struct ConstInfo &constInfo,
                                      const NanovllmSparseAndTailAttentionTilingDataMla *__restrict tilingData);
...
#endif // NANOVLLM_SPARSE_AND_TAIL_ATTENTION_SERVICE_VECTOR_MLA_H
