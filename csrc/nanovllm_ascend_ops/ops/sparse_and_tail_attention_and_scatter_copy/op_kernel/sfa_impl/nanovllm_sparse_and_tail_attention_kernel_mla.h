...
/*!
 * \file nanovllm_sparse_and_tail_attention_kernel_mla.h
 * \brief
 */

#ifndef NANOVLLM_SPARSE_AND_TAIL_ATTENTION_KERNEL_MLA_H
#define NANOVLLM_SPARSE_AND_TAIL_ATTENTION_KERNEL_MLA_H
...
#include "nanovllm_sparse_and_tail_attention_common.h"
#include "nanovllm_sparse_and_tail_attention_service_cube_mla.h"
#include "nanovllm_sparse_and_tail_attention_service_vector_mla.h"
...
template <typename SFAT> class NanovllmSparseAndTailAttentionMla {
public:
    using T = float;
    ...
    __aicore__ inline NanovllmSparseAndTailAttentionMla(){};
    __aicore__ inline void Init(__gm__ uint8_t *query, __gm__ uint8_t *key, __gm__ uint8_t *value,
                                ...
                                const NanovllmSparseAndTailAttentionTilingDataMla *__restrict tiling,
...
private:
    ...
    const NanovllmSparseAndTailAttentionTilingDataMla *__restrict tilingData = nullptr;
...
template <typename SFAT> __aicore__ inline void NanovllmSparseAndTailAttentionMla<SFAT>::InitTilingData()
{
...
template <typename SFAT> __aicore__ inline void NanovllmSparseAndTailAttentionMla<SFAT>::InitBuffers()
{
    if ASCEND_IS_AIV {
...
NanovllmSparseAndTailAttentionMla<SFAT>::InitActualSeqLen(__gm__ uint8_t *actualSeqLengthsQ,
...
template <typename SFAT>
__aicore__ inline void NanovllmSparseAndTailAttentionMla<SFAT>::InitAllZeroOutput(uint32_t bIdx, uint32_t s1Idx, uint32_t n2Idx)
{
...
template <typename SFAT>
__aicore__ inline void NanovllmSparseAndTailAttentionMla<SFAT>::InitOutputSingleCore()
{
...
template <typename SFAT>
__aicore__ inline void NanovllmSparseAndTailAttentionMla<SFAT>::GetActualSeqLen(uint32_t bIdx, uint32_t s1Idx)
{
    (void)s1Idx;
...
template <typename SFAT>
__aicore__ inline uint64_t NanovllmSparseAndTailAttentionMla<SFAT>::GetTopKRowOffset(uint32_t bIdx, uint32_t s1Idx,
                                                                           uint32_t n2Idx)
{
    (void)s1Idx;
    (void)n2Idx;
...
template <typename SFAT>
__aicore__ inline void NanovllmSparseAndTailAttentionMla<SFAT>::GetSparseActualSeqLen(uint32_t bIdx, uint32_t s1Idx,
                                                                            uint32_t n2Idx)
{
    (void)bIdx;
    (void)s1Idx;
...
template <typename SFAT>
__aicore__ inline uint32_t NanovllmSparseAndTailAttentionMla<SFAT>::GetActualSeqLenKV(uint32_t bIdx)
{
...
template <typename SFAT>
__aicore__ inline void NanovllmSparseAndTailAttentionMla<SFAT>::DealActSeqLenIsZero(uint32_t bIdx, uint32_t s1Idx, uint32_t n2Idx)
{
    if ASCEND_IS_AIV {
...
template <typename SFAT>
__aicore__ inline void NanovllmSparseAndTailAttentionMla<SFAT>::GetPreNextTokensLeftUp()
{
...
template <typename SFAT> __aicore__ inline void NanovllmSparseAndTailAttentionMla<SFAT>::UpdateInnerLoopCond()
{
...
template <typename SFAT>
__aicore__ inline void NanovllmSparseAndTailAttentionMla<SFAT>::UpdateInner(uint32_t &s2End, uint32_t &curS2End,
...
template <typename SFAT>
__aicore__ inline void NanovllmSparseAndTailAttentionMla<SFAT>::Init(__gm__ uint8_t *query,
...
template <typename SFAT>
__aicore__ inline void
NanovllmSparseAndTailAttentionMla<SFAT>::InitSourceAwareGather(
    __gm__ uint8_t *dramKeyRope, __gm__ uint8_t *dramKey,
    __gm__ uint8_t *dramBlockTable, __gm__ uint8_t *sourceTokenIds,
    __gm__ uint8_t *copyCounts, uint32_t copyCap,
    uint32_t dramMaxBlockNum)
...
template <typename SFAT> __aicore__ inline void NanovllmSparseAndTailAttentionMla<SFAT>::InitCalcParamsEach()
{
...
template <typename SFAT>
__aicore__ inline void
NanovllmSparseAndTailAttentionMla<SFAT>::Bmm2DataCopyOut(uint64_t attenOutOffset, LocalTensor<OUT_T> &attenOutUb,
...
template <typename SFAT>
__aicore__ inline void NanovllmSparseAndTailAttentionMla<SFAT>::CalcParams(uint32_t loop, uint64_t s2Start,
...
template <typename SFAT>
__aicore__ inline void NanovllmSparseAndTailAttentionMla<SFAT>::ComputeMm1(const RunInfo &info)
{
...
template <typename SFAT>
__aicore__ inline void NanovllmSparseAndTailAttentionMla<SFAT>::ComputeMm2(const RunInfo &info)
{
    uint32_t nBufferLoopTimes = (info.actMBaseSize + constInfo.nBufferMBaseSize - 1) / constInfo.nBufferMBaseSize;
    uint32_t nBufferTail = info.actMBaseSize - (nBufferLoopTimes - 1) * constInfo.nBufferMBaseSize;
    for (uint32_t i = 0; i < nBufferLoopTimes; i++) {
...
template <typename SFAT> __aicore__ inline void NanovllmSparseAndTailAttentionMla<SFAT>::Process()
{
    if (aiCoreIdx < usedCoreNum) {
        if ASCEND_IS_AIV {
...
template <typename SFAT>
__aicore__ inline void NanovllmSparseAndTailAttentionMla<SFAT>::GetBN2Idx(uint32_t bN2Idx, uint32_t &bIdx,
                                                                                uint32_t &n2Idx)
{
...
template <typename SFAT> __aicore__ inline void NanovllmSparseAndTailAttentionMla<SFAT>::ProcessBalance()
{
...
template <typename SFAT>
__aicore__ inline void
NanovllmSparseAndTailAttentionMla<SFAT>::PreloadPipeline(uint32_t loop, uint64_t s2Start, uint64_t s2LoopIdx,
                                                               RunInfo extraInfo[SFA_PRELOAD_TASK_CACHE_SIZE], uint32_t &curTopKIdx, uint64_t &curOffsetInSparseBlock)
{
...
NanovllmSparseAndTailAttentionMla<SFAT>::GetBalanceActualSeqLengths(GlobalTensor<int32_t> &actualSeqLengths,
                                                                          uint32_t bIdx)
{
...
template <typename SFAT>
__aicore__ inline void NanovllmSparseAndTailAttentionMla<SFAT>::GetAxisStartIdx(uint32_t bN2EndPrev,
                                                                                      uint32_t s1GEndPrev,
                                                                                      uint32_t s2EndPrev)
{
...
template <typename SFAT>
__aicore__ inline void NanovllmSparseAndTailAttentionMla<SFAT>::CalcSinnerTopKBegin(RunInfo &info, uint32_t &curTopKIdx, uint64_t &curOffsetInSparseBlock)
...
#endif // NANOVLLM_SPARSE_AND_TAIL_ATTENTION_KERNEL_MLA_H
