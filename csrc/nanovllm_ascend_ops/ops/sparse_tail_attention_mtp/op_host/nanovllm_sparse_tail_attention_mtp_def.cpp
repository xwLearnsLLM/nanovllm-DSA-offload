...
namespace ops {
class NanovllmSparseTailAttentionMtp : public OpDef {
public:
    explicit NanovllmSparseTailAttentionMtp(const char *name) : OpDef(name)
    {
        this->Input("query")
...
OP_ADD(NanovllmSparseTailAttentionMtp);
} // namespace ops
