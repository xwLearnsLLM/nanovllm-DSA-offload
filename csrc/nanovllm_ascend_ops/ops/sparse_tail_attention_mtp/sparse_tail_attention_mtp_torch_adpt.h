#ifndef NANOVLLM_SPARSE_TAIL_ATTENTION_MTP_TORCH_ADPT_H
#define NANOVLLM_SPARSE_TAIL_ATTENTION_MTP_TORCH_ADPT_H

namespace vllm_ascend {

inline void npu_sparse_tail_attention_mtp_out(
  ...
  EXEC_NPU_CMD_ORDERED(
      aclnnNanovllmSparseTailAttentionMtp,
      keepalive,
      query,
      key,
      value,
...
inline at::Tensor npu_sparse_tail_attention_mtp(
    const at::Tensor& query,
    const at::Tensor& key,
    const at::Tensor& value,
    const at::Tensor& sparse_slots,
