...
/*!
 * \file nanovllm_sparse_and_tail_attention_tiling.h
 * \brief
 */
#ifndef NANOVLLM_SPARSE_AND_TAIL_ATTENTION_TILING_H
#define NANOVLLM_SPARSE_AND_TAIL_ATTENTION_TILING_H
...
BEGIN_TILING_DATA_DEF(NanovllmSparseAndTailAttentionBaseParamsMla)
...
END_TILING_DATA_DEF
REGISTER_TILING_DATA_CLASS(NanovllmSparseAndTailAttentionBaseParamsMlaOp, NanovllmSparseAndTailAttentionBaseParamsMla)

BEGIN_TILING_DATA_DEF(NanovllmSparseAndTailAttentionSingleCoreParamsMla)
TILING_DATA_FIELD_DEF(uint32_t, usedCoreNum);
END_TILING_DATA_DEF
REGISTER_TILING_DATA_CLASS(NanovllmSparseAndTailAttentionSingleCoreParamsMlaOp, NanovllmSparseAndTailAttentionSingleCoreParamsMla)

BEGIN_TILING_DATA_DEF(NanovllmSparseAndTailAttentionSingleCoreTensorSizeMla)
TILING_DATA_FIELD_DEF(uint32_t, mmResUbSize);
TILING_DATA_FIELD_DEF(uint32_t, bmm2ResUbSize);
END_TILING_DATA_DEF
REGISTER_TILING_DATA_CLASS(NanovllmSparseAndTailAttentionSingleCoreTensorSizeMlaOp, NanovllmSparseAndTailAttentionSingleCoreTensorSizeMla)

BEGIN_TILING_DATA_DEF(NanovllmSparseAndTailAttentionSplitKVParamsMla)
...
END_TILING_DATA_DEF
REGISTER_TILING_DATA_CLASS(NanovllmSparseAndTailAttentionSplitKVParamsMlaOp, NanovllmSparseAndTailAttentionSplitKVParamsMla)

BEGIN_TILING_DATA_DEF(NanovllmSparseAndTailAttentionInnerSplitParams)
TILING_DATA_FIELD_DEF(uint32_t, mBaseSize)
TILING_DATA_FIELD_DEF(uint32_t, s2BaseSize)
END_TILING_DATA_DEF
REGISTER_TILING_DATA_CLASS(NanovllmSparseAndTailAttentionInnerSplitParamsOp, NanovllmSparseAndTailAttentionInnerSplitParams)

BEGIN_TILING_DATA_DEF(NanovllmSparseAndTailAttentionTilingDataMla)
...
private:
    ...
    NanovllmSparseAndTailAttentionTilingDataMla tilingData_;
