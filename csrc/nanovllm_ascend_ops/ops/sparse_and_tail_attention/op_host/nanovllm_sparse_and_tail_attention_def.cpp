...
/*!
 * \file nanovllm_sparse_and_tail_attention_def.cpp
 * \brief
 */
...
namespace ops {
class NanovllmSparseAndTailAttention : public OpDef {
public:
    explicit NanovllmSparseAndTailAttention(const char *name) : OpDef(name)
    {
        this->Input("query")
            .ParamType(REQUIRED)
...
OP_ADD(NanovllmSparseAndTailAttention);
} // namespace ops
