...
/*!
 * \file nanovllm_sparse_and_tail_attention_common.h
 * \brief
 */

#ifndef NANOVLLM_SPARSE_AND_TAIL_ATTENTION_COMMON_H
#define NANOVLLM_SPARSE_AND_TAIL_ATTENTION_COMMON_H
...
#endif // NANOVLLM_SPARSE_AND_TAIL_ATTENTION_COMMON_H
