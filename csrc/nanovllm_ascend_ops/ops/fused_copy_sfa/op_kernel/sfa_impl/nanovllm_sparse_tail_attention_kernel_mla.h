...
/*!
 * \file nanovllm_sparse_tail_attention_kernel_mla.h
 * \brief
 */
...
#include "nanovllm_sparse_tail_attention_common.h"
#include "nanovllm_sparse_tail_attention_service_cube_mla.h"
#include "nanovllm_sparse_tail_attention_service_vector_mla.h"
...
template <typename SFAT> class NanovllmSparseTailAttentionMla {
public:
    using T = float;
    ...
    __aicore__ inline NanovllmSparseTailAttentionMla(){};
    __aicore__ inline void Init(__gm__ uint8_t *query, __gm__ uint8_t *key, __gm__ uint8_t *value,
                                ...
                                const NanovllmSparseTailAttentionTilingDataMla *__restrict tiling,
...
private:
    ...
    const NanovllmSparseTailAttentionTilingDataMla *__restrict tilingData = nullptr;
...
template <typename SFAT> __aicore__ inline void NanovllmSparseTailAttentionMla<SFAT>::InitTilingData()
{
...
template <typename SFAT> __aicore__ inline void NanovllmSparseTailAttentionMla<SFAT>::InitBuffers()
{
    if ASCEND_IS_AIV {
...
NanovllmSparseTailAttentionMla<SFAT>::InitActualSeqLen(__gm__ uint8_t *actualSeqLengthsQ,
...
template <typename SFAT>
__aicore__ inline void NanovllmSparseTailAttentionMla<SFAT>::InitAllZeroOutput(uint32_t bIdx, uint32_t s1Idx, uint32_t n2Idx)
{
...
template <typename SFAT>
__aicore__ inline void NanovllmSparseTailAttentionMla<SFAT>::InitOutputSingleCore()
{
...
template <typename SFAT>
__aicore__ inline void NanovllmSparseTailAttentionMla<SFAT>::GetActualSeqLen(uint32_t bIdx, uint32_t s1Idx)
{
    (void)s1Idx;
...
template <typename SFAT>
__aicore__ inline uint32_t NanovllmSparseTailAttentionMla<SFAT>::GetActualSeqLenKV(uint32_t bIdx)
{
...
template <typename SFAT>
__aicore__ inline void NanovllmSparseTailAttentionMla<SFAT>::DealActSeqLenIsZero(uint32_t bIdx, uint32_t s1Idx, uint32_t n2Idx)
{
    if ASCEND_IS_AIV {
...
template <typename SFAT>
__aicore__ inline void NanovllmSparseTailAttentionMla<SFAT>::GetPreNextTokensLeftUp()
{
...
template <typename SFAT> __aicore__ inline void NanovllmSparseTailAttentionMla<SFAT>::UpdateInnerLoopCond()
{
...
template <typename SFAT>
__aicore__ inline void NanovllmSparseTailAttentionMla<SFAT>::UpdateInner(uint32_t &s2End, uint32_t &curS2End,
...
template <typename SFAT>
__aicore__ inline void NanovllmSparseTailAttentionMla<SFAT>::Init(__gm__ uint8_t *query,
...
template <typename SFAT> __aicore__ inline void NanovllmSparseTailAttentionMla<SFAT>::InitCalcParamsEach()
{
...
template <typename SFAT>
__aicore__ inline void
NanovllmSparseTailAttentionMla<SFAT>::Bmm2DataCopyOut(uint64_t attenOutOffset, LocalTensor<OUT_T> &attenOutUb,
...
template <typename SFAT>
__aicore__ inline void NanovllmSparseTailAttentionMla<SFAT>::CalcParams(uint32_t loop, uint64_t s2Start,
...
template <typename SFAT>
__aicore__ inline void NanovllmSparseTailAttentionMla<SFAT>::ComputeMm1(const RunInfo &info)
{
...
template <typename SFAT>
__aicore__ inline void NanovllmSparseTailAttentionMla<SFAT>::ComputeMm2(const RunInfo &info)
{
    uint32_t nBufferLoopTimes = (info.actMBaseSize + constInfo.nBufferMBaseSize - 1) / constInfo.nBufferMBaseSize;
    uint32_t nBufferTail = info.actMBaseSize - (nBufferLoopTimes - 1) * constInfo.nBufferMBaseSize;
    for (uint32_t i = 0; i < nBufferLoopTimes; i++) {
...
template <typename SFAT> __aicore__ inline void NanovllmSparseTailAttentionMla<SFAT>::Process()
{
    if (aiCoreIdx < usedCoreNum) {
        if ASCEND_IS_AIV {
...
template <typename SFAT>
__aicore__ inline void NanovllmSparseTailAttentionMla<SFAT>::GetBN2Idx(uint32_t bN2Idx, uint32_t &bIdx,
                                                                                uint32_t &n2Idx)
{
...
template <typename SFAT> __aicore__ inline void NanovllmSparseTailAttentionMla<SFAT>::ProcessBalance()
{
...
template <typename SFAT>
__aicore__ inline void
NanovllmSparseTailAttentionMla<SFAT>::PreloadPipeline(uint32_t loop, uint64_t s2Start, uint64_t s2LoopIdx,
                                                               RunInfo extraInfo[SFA_PRELOAD_TASK_CACHE_SIZE], uint32_t &curTopKIdx, uint64_t &curOffsetInSparseBlock)
{
...
NanovllmSparseTailAttentionMla<SFAT>::GetBalanceActualSeqLengths(GlobalTensor<int32_t> &actualSeqLengths,
                                                                          uint32_t bIdx)
{
...
template <typename SFAT>
__aicore__ inline void NanovllmSparseTailAttentionMla<SFAT>::GetAxisStartIdx(uint32_t bN2EndPrev,
                                                                                      uint32_t s1GEndPrev,
                                                                                      uint32_t s2EndPrev)
{
...
template <typename SFAT>
__aicore__ inline void NanovllmSparseTailAttentionMla<SFAT>::CalcSinnerTopKBegin(RunInfo &info, uint32_t &curTopKIdx, uint64_t &curOffsetInSparseBlock)
