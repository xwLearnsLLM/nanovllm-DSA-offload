#include "nanovllm_fused_copy_sfa_tiling.h"
...
ge::graphStatus TilingNanovllmFusedCopySfa(
    gert::TilingContext *context)
{
    ...
    OPS_ERR_IF(raw == nullptr,
               ...
               return ge::GRAPH_FAILED);
    NanovllmFusedCopySfaTilingData fusedTiling;
...
ge::graphStatus TilingPrepareNanovllmFusedCopySfa(
...
IMPL_OP_OPTILING(NanovllmFusedCopySfa)
    .Tiling(TilingNanovllmFusedCopySfa)
    .TilingParse<NanovllmFusedCopySfaCompileInfo>(
        TilingPrepareNanovllmFusedCopySfa);
