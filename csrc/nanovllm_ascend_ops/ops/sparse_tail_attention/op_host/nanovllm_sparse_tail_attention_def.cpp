...
/*!
 * \file nanovllm_sparse_tail_attention_def.cpp
 * \brief
 */
...
namespace ops {
class NanovllmSparseTailAttention : public OpDef {
public:
    explicit NanovllmSparseTailAttention(const char *name) : OpDef(name)
    {
        this->Input("query")
            .ParamType(REQUIRED)
...
OP_ADD(NanovllmSparseTailAttention);
} // namespace ops
