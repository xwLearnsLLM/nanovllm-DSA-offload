...
/*!
 * \file nanovllm_sparse_tail_attention_tiling.h
 * \brief
 */
...
BEGIN_TILING_DATA_DEF(NanovllmSparseTailAttentionBaseParamsMla)
...
END_TILING_DATA_DEF
REGISTER_TILING_DATA_CLASS(NanovllmSparseTailAttentionBaseParamsMlaOp, NanovllmSparseTailAttentionBaseParamsMla)

BEGIN_TILING_DATA_DEF(NanovllmSparseTailAttentionSingleCoreParamsMla)
TILING_DATA_FIELD_DEF(uint32_t, usedCoreNum);
END_TILING_DATA_DEF
REGISTER_TILING_DATA_CLASS(NanovllmSparseTailAttentionSingleCoreParamsMlaOp, NanovllmSparseTailAttentionSingleCoreParamsMla)

BEGIN_TILING_DATA_DEF(NanovllmSparseTailAttentionSingleCoreTensorSizeMla)
TILING_DATA_FIELD_DEF(uint32_t, mmResUbSize);
TILING_DATA_FIELD_DEF(uint32_t, bmm2ResUbSize);
END_TILING_DATA_DEF
REGISTER_TILING_DATA_CLASS(NanovllmSparseTailAttentionSingleCoreTensorSizeMlaOp, NanovllmSparseTailAttentionSingleCoreTensorSizeMla)

BEGIN_TILING_DATA_DEF(NanovllmSparseTailAttentionSplitKVParamsMla)
...
END_TILING_DATA_DEF
REGISTER_TILING_DATA_CLASS(NanovllmSparseTailAttentionSplitKVParamsMlaOp, NanovllmSparseTailAttentionSplitKVParamsMla)

BEGIN_TILING_DATA_DEF(NanovllmSparseTailAttentionInnerSplitParams)
TILING_DATA_FIELD_DEF(uint32_t, mBaseSize)
TILING_DATA_FIELD_DEF(uint32_t, s2BaseSize)
END_TILING_DATA_DEF
REGISTER_TILING_DATA_CLASS(NanovllmSparseTailAttentionInnerSplitParamsOp, NanovllmSparseTailAttentionInnerSplitParams)

BEGIN_TILING_DATA_DEF(NanovllmSparseTailAttentionTilingDataMla)
...
END_TILING_DATA_DEF
REGISTER_TILING_DATA_CLASS(NanovllmSparseTailAttention, NanovllmSparseTailAttentionTilingDataMla)
REGISTER_TILING_DATA_CLASS(NanovllmSparseTailAttentionMtp, NanovllmSparseTailAttentionTilingDataMla)
...
private:
    ...
    NanovllmSparseTailAttentionTilingDataMla tilingData_;
