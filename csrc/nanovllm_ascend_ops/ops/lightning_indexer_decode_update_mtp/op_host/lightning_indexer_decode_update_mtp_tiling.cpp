...
#include "lightning_indexer_decode_update_mtp_tiling.h"
#include <algorithm>
#include "../op_kernel/lightning_indexer_decode_update_mtp_template_tiling_key.h"
...
ge::graphStatus LIUMtpTiling::GetPlatform(LIUMtpTilingInfo &info) const
{
    ...
    OPS_ERR_IF(info.opName == nullptr,
               OPS_LOG_E("NanovllmLiduDecodeUpdateMtp", "node name is nullptr."),
...
static ge::graphStatus TilingForNanovllmLiduDecodeUpdateMtp(
    gert::TilingContext *context)
{
    OPS_ERR_IF(context == nullptr,
               OPS_REPORT_VECTOR_INNER_ERR("NanovllmLiduDecodeUpdateMtp",
...
IMPL_OP_OPTILING(NanovllmLiduDecodeUpdateMtp)
    .Tiling(TilingForNanovllmLiduDecodeUpdateMtp)
