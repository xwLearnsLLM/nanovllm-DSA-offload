...
static ge::graphStatus InferShapeNanovllmLiduDecodeUpdateMtp(
    gert::InferShapeContext *context)
{
    OPS_ERR_IF(context == nullptr,
               OPS_LOG_E("NanovllmLiduDecodeUpdateMtp",
...
static ge::graphStatus InferDataTypeNanovllmLiduDecodeUpdateMtp(
...
IMPL_OP_INFERSHAPE(NanovllmLiduDecodeUpdateMtp)
    .InferShape(InferShapeNanovllmLiduDecodeUpdateMtp)
    .InferDataType(InferDataTypeNanovllmLiduDecodeUpdateMtp);
} // namespace ops
