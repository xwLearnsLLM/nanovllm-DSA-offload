...
#ifndef NANOVLLM_LIDU_DECODE_UPDATE_MTP_TILING_H_
#define NANOVLLM_LIDU_DECODE_UPDATE_MTP_TILING_H_
...
END_TILING_DATA_DEF
REGISTER_TILING_DATA_CLASS(NanovllmLiduDecodeUpdateMtp, LIUMtpTilingData)
