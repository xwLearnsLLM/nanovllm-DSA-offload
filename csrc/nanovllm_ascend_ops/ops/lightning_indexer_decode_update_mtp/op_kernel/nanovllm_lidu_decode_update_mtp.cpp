...
#include "lightning_indexer_decode_update_mtp_template_tiling_key.h"
#include "lightning_indexer_decode_update_mtp_kernel.h"
...
template <int DT>
__global__ __aicore__ void nanovllm_lidu_decode_update_mtp(
