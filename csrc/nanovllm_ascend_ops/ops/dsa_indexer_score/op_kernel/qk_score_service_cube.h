...
/*!
 * \file qk_score_service_cube.h
 * \brief use 5 buffer for matmul l1, better pipeline
 */
#ifndef QK_SCORE_SERVICE_CUBE_H
#define QK_SCORE_SERVICE_CUBE_H
...
public:
    ...
    __aicore__ inline void ComputeMm1(const QKCommon::RunInfo &runInfo);
...
protected:
    __aicore__ inline void Fixp(uint64_t s1gGmOffset, uint64_t s2GmOffset, uint64_t s1gL0RealSize,
                                uint64_t s2L0RealSize, const QKCommon::RunInfo &runInfo);
    __aicore__ inline void ComuteL0c(uint64_t s1gL0RealSize, uint64_t s2L0RealSize, const QKCommon::RunInfo &runInfo);
    __aicore__ inline void LoadKeyToL0b(uint64_t s2L0Offset, uint64_t s2L1RealSize, uint64_t s2L0RealSize,
                                        const QKCommon::RunInfo &runInfo);
    __aicore__ inline void LoadQueryToL0a(uint64_t s1gL1Offset, uint64_t s1gL0Offset, uint64_t s1gL1RealSize,
                                          uint64_t s1gL0RealSize, const QKCommon::RunInfo &runInfo);
    __aicore__ inline void QueryNd2Nz(uint64_t s1gL1RealSize, uint64_t s1gL1Offset, const QKCommon::RunInfo &runInfo);
    __aicore__ inline void KeyNd2Nz(uint64_t s2L1RealSize, uint64_t s2GmOffset, const QKCommon::RunInfo &runInfo);
    __aicore__ inline void KeyNd2NzForPA(uint64_t s2L1RealSize, uint64_t s2GmOffset, const QKCommon::RunInfo &runInfo);
...
template <typename QKT>
__aicore__ inline void QKMatmul<QKT>::InitParams(const ConstInfo &constInfo)
{
    constInfo_ = constInfo;
}

template <typename QKT>
__aicore__ inline void QKMatmul<QKT>::InitBuffers(TPipe *pipe)
{
...
QKMatmul<QKT>::InitMm1GlobalTensor(const GlobalTensor<int32_t> &blkTableGm, const GlobalTensor<K_T> &keyGm,
                                   const GlobalTensor<Q_T> &queryGm, const GlobalTensor<float> &mm1ResGm)
{
...
template <typename QKT>
__aicore__ inline void QKMatmul<QKT>::ComputeMm1(const QKCommon::RunInfo &runInfo)
{
...
template <typename QKT>
__aicore__ inline void QKMatmul<QKT>::KeyNd2Nz(uint64_t s2L1RealSize, uint64_t s2GmOffset,
                                                    const QKCommon::RunInfo &runInfo)
{
...
// blkNum, blkSize, N2, D
template <typename QKT>
__aicore__ inline void QKMatmul<QKT>::KeyNd2NzForPA(uint64_t s2L1RealSize, uint64_t s2GmOffset,
                                                    const QKCommon::RunInfo &runInfo)
{
    uint64_t s2L1Offset = 0;
    while (s2L1Offset < s2L1RealSize) {
...
// batch, s1, n2, g, d
template <typename QKT>
__aicore__ inline void QKMatmul<QKT>::QueryNd2Nz(uint64_t s1gL1RealSize, uint64_t s1gGmOffset,
                                                 const QKCommon::RunInfo &runInfo)
{
    Nd2NzParams nd2nzPara;
    nd2nzPara.ndNum = 1;
...
template <typename QKT>
__aicore__ inline void QKMatmul<QKT>::LoadQueryToL0a(uint64_t s1gGmOffset, uint64_t s1gL1Offset, uint64_t s1gL1RealSize,
                                                     uint64_t s1gL0RealSize, const QKCommon::RunInfo &runInfo)
{
...
template <typename QKT>
__aicore__ inline void QKMatmul<QKT>::LoadKeyToL0b(uint64_t s2L1Offset, uint64_t s2L1RealSize, uint64_t s2L0RealSize,
                                                   const QKCommon::RunInfo &runInfo)
{
...
template <typename QKT>
__aicore__ inline void QKMatmul<QKT>::ComuteL0c(uint64_t s1gL0RealSize, uint64_t s2L0RealSize,
                                                const QKCommon::RunInfo &runInfo)
{
...
template <typename QKT>
__aicore__ inline void QKMatmul<QKT>::Fixp(uint64_t s1gGmOffset, uint64_t s2GmOffset, uint64_t s1gL0RealSize,
                                           uint64_t s2L0RealSize, const QKCommon::RunInfo &runInfo)
{
...
template <typename QKT>
__aicore__ inline void QKMatmul<QKT>::AllocEventID()
{
...
template <typename QKT>
__aicore__ inline void QKMatmul<QKT>::FreeEventID()
{
